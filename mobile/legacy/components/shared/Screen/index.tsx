...
import { ExtendedEdge, useSafeAreaInsetsStyle } from "core-module/services"
...
function ScreenSpinner(props: ScreenSpinnerProps) {
  const { color = "white", containerStyle } = props
  return (
    <View
      style={[
        {
...
export default function Screen(props: ScreenProps) {
  ...
  return (
    <View style={[$containerStyle, { backgroundColor }, $containerInsets]}>
      <StatusBar style={statusBarStyle} animated={false} {...StatusBarProps} />
      {loading ? (
        <ScreenSpinner />
      ) : (
        <KeyboardAvoidingView
