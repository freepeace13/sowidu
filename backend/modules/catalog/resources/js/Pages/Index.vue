...
import CatalogItemDetailsModal from '~Catalog/Components/CatalogItemDetailsModal.vue'
import CatalogItemForm from '~Catalog/Components/CatalogItemForm.vue'
import { authCan } from '~Shared/Composables/useAuth'
