...
use Modules\Todos\Events\Task\TaskCreated;
use Modules\Todos\Events\Task\TaskDeleted;
use Modules\Todos\Events\Task\TaskMemberAdded;
use Modules\Todos\Events\Task\TaskMemberRemoved;
use Modules\Todos\Events\Task\TaskUpdated;
...
class Task extends Model
{
    ...
    public function manualTasks(): HasOne
    {
        return $this->hasOne(TodoManualTask::class, 'todo_task_id');
    }
