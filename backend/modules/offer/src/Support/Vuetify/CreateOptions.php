...
namespace Modules\Offer\Support\Vuetify;
...
/**
 * Helper class for creating Vuetify-compatible select options.
 */
class CreateOptions
{
    ...
    public static function from(Arrayable|array $items): static
    {
