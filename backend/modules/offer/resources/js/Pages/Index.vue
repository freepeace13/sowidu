                    ...
                    >
                        <template #items="itemProps">
                            <OfferRow
                                ...
                                :editable="
                                    itemProps.item.permissions?.editable ??
                                    false
                                "
                                :deletable="
                                    itemProps.item.permissions?.deletable ??
                                    false
                                "
                                ...
                                "
                                @click:edit="
                                    (offer) => $refs.offerFormRef.show(offer)
                                "
                                @click:delete="
                                    (offer) => confirmDeleting(offer)
                                "
                                @click:show-details="
                                    (offer) =>
                                        router.get(
