...
import { Order, Employee, Task, Delivery, Media, Item } from './models';
import * as apiCalls from './api/order';
...
export const transformers = {
    ...
    incoming: {
        $update: (instance: Order) => ({
            ...
            customer: instance.customer.toMorphs(),
        })
    }
}

export class OrderService extends ServiceProvider {
    async all(filters: Array = {}): Promise<Array<Order>> {
