...
<body class="tw-d-flex tw-flex-col tw-h-screen" style="background-color: #c0e8ff;">
    ...
    <div class="tw-font-sans tw-w-1/2 tw-mx-auto tw-flex-1 tw-flex tw-justify-center tw-items-center tw-flex-col tw-h-full">
        ...
        <img src="{{ asset('/images/errors/419.webp')}}" />
        <h2 class="tw-text-[#006686] tw-text-7xl tw-font-bold tw-mb-0">419 Page Expired (CSRF mismatch)</h2>
        <h3 class="tw-text-[#4D616C] tw-text-5xl">Your session expired, please try again.</h3>
