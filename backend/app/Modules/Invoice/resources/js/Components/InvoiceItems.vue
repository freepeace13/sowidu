...
import EditInvoiceItemForm from './Item/EditInvoiceItemForm.vue'
import EditInvoiceItemRateForm from './Item/EditInvoiceItemRateForm.vue'
import InvoiceItem from './Item/InvoiceItem.vue'
import InvoiceItemDetails from './Item/InvoiceItemDetails.vue'
...
const invoiceSummary = computed(() => {
    const summary = getPageProps('invoiceSummary') || {}
    return {
        ...summary,
