...
import DeductionOptions from '../Components/Deduction/DeductionOptions.vue'
import InvoiceDocuments from '../Components/Document/InvoiceDocuments.vue'
import InvoiceItemForm from '../Components/Item/InvoiceItemForm.vue'
import InvoiceItems from '../Components/InvoiceItems.vue'
import InvoicePaymentDateForm from '../Components/Payment/InvoicePaymentDateForm.vue'
import InvoicePayments from '../Components/Payment/InvoicePayments.vue'
import InvoiceTaxForm from '../Components/InvoiceTaxForm.vue'
import ManualItemForm from '../Components/Item/ManualItemForm.vue'
...
<template>
    <div>
        ...
        <portal-target name="invoice-notes-dialog" />
    </div>
</template>
