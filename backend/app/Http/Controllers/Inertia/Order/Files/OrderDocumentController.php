...
use App\Actions\Order\File\Document\AttachDocumentToOrder;
use App\Actions\Order\File\Document\DetachDocumentFromOrder;
...
class OrderDocumentController extends InertiaController
{
    ...
    public function store(Request $request, Order $order, AttachDocumentToOrder $attacher)
    {
    ...
    public function destroy(
        ...
        Order $order,
        MediaFile $media,
        DetachDocumentFromOrder $detacher,
    ) {
